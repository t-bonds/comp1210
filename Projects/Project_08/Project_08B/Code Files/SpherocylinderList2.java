   ...
   */
   ...
   public Spherocylinder findSpherocylinderWithShortestRadius() {
      ...
      if (numElements <= 0) {
         ...
         double small = aList[0].getRadius();
         var = aList[0];
         for (int i = 1; i < numElements; i++) {
         
            if (aList[i].getRadius() < small) {
            
               small = aList[i].getRadius();
               var = aList[i];
            }
         }
      }
   ...
   */
   ...
   public Spherocylinder findSpherocylinderWithLongestRadius() {
      ...
      if (numElements <= 0) {
         ...
         double large = aList[0].getRadius();
         var = aList[0];
         for (int i = 1; i < numElements; i++) {
         
            if (aList[i].getRadius() > large) {
            
               large = aList[i].getRadius();
               var = aList[i];
            }
         }
      }
   ...
   */
   ...
   public Spherocylinder findSpherocylinderWithSmallestVolume() {
      ...
      if (numElements <= 0) {
         ...
         double small = aList[0].volume();
         var = aList[0];
         for (int i = 1; i < numElements; i++) {
         
            if (aList[i].volume() < small) {
            
               small = aList[i].volume();
               var = aList[i];
            }
         }
      }
   ...
   */
   ...
   public Spherocylinder findSpherocylinderWithLargestVolume() {
      ...
      if (numElements <= 0) {
         ...
         double large = aList[0].volume();
         var = aList[0];
         for (int i = 1; i < numElements; i++) {
         
            if (aList[i].volume() > large) {
            
               large = aList[i].volume();
               var = aList[i];
            }
         }
      }
